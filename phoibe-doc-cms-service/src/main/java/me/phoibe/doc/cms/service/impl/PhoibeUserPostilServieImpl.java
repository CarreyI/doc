...
public class PhoibeUserPostilServieImpl implements PhoibeUserPostilService {
    ...
    @Override
    public PageList<PhoibeUserPostil> fetchMyUserPostilList(PageParam<PhoibeUserPostil> param){
        List<PhoibeUserPostil> dlist = new ArrayList<>();
        List<PhoibeUserPostil> list = phoibeUserPostilMapper.fetchMyUserPostilList(param);
       /* for (PhoibeUserPostil model:list){
            PhoibeUserPostil dmodel = new PhoibeUserPostil();
            BeanUtils.copyProperties(model,dmodel);
            //dmodel.settings();
        ...
        return PageList.createPage(param,phoibeUserPostilMapper.selectCountByPage(param),list);
    }
