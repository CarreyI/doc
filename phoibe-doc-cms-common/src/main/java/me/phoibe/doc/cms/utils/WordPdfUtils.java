...
public class WordPdfUtils {
    ...
    public static void main(String[] args) throws Exception {
        String finalDirPath = "F:/Java_WorkSpace/satic/docword/";
        String filepath = finalDirPath + "88a19aeeec8ce7c5c396dfb370d1d7c9/吉他初学入门.docx";
        String outpath = finalDirPath + "88a19aeeec8ce7c5c396dfb370d1d7c9/吉他初学入门.pdf";
    ...
    /*** 将word文档， 转换成pdf, 中间替换掉变量
     * * @param source 源为word文档， 必须为docx文档
     * * @param target 目标输出* @param params 需要替换的变量
